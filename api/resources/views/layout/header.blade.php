				...
				<ul class="list-reset flex flex-1 items-center md:flex-none">
					<li class="flex-1 md:mr-3 md:flex-none">
						<div class="relative inline-block">
							<button class="drop-button py-2 px-2 text-white" onclick="toggleDD('myDropdown')">
							...
							<div class="dropdownlist invisible absolute right-0 z-30 mt-3 overflow-auto bg-gray-800 p-3 text-white"
								id="myDropdown">
