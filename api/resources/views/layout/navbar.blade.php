    ...
    <div class="content-center justify-between text-left md:fixed md:left-0 md:top-0 md:mt-12 md:w-48 md:content-start">
      <ul class="list-reset flex flex-row px-1 pt-3 text-center md:flex-col md:py-3 md:px-2 md:text-left">
        <li class="mr-3 flex-1">
          <a href="home" class="{{ $active === 'home' ? 'border-blue-600' : 'border-gray-800' }} block border-b-2 py-1 pl-1 align-middle text-white no-underline hover:border-blue-500 hover:text-white md:py-3">
            <i class="fas fa-chart-area {{ $active === 'home' ? 'text-blue-600' : '' }} pr-0 md:pr-3"></i>
            <span class="block pb-1 text-xs text-gray-400 md:inline-block md:pb-0 md:text-base md:text-gray-200">Dashboard</span>
          </a>
        </li>
        ...
        <li class="mr-3 flex-1">
          <a href="notif" class="{{ $active === 'notif' ? 'border-pink-600' : 'border-gray-800' }} block border-b-2 py-1 pl-1 align-middle text-white no-underline hover:border-pink-500 hover:text-white md:py-3">
            <i class="fas fa-bell {{ $active === 'notif' ? 'text-pink-600' : '' }} pr-0 md:pr-3"></i>
